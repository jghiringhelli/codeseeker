...
class ToolDatabaseAPI {
  ...
  async getTreeNavigationData(projectId: string, filters: any = {}) {
  ...
  async saveTreeNavigationData(projectId: string, data: any[]) {
  ...
  async getCodeDuplications(projectId: string, filters: any = {}) {
  ...
  async saveCodeDuplications(projectId: string, data: any[]) {
    const client = await this.pool.connect();
  ...
  async getCentralizationOpportunities(projectId: string, filters: any = {}) {
  ...
  async saveCentralizationOpportunities(projectId: string, data: any[]) {
    const client = await this.pool.connect();
  ...
  async getTestCoverageData(projectId: string, filters: any = {}) {
  ...
  async saveTestCoverageData(projectId: string, data: any[]) {
    const client = await this.pool.connect();
  ...
  async getCompilationResults(projectId: string, filters: any = {}) {
  ...
  async saveCompilationResults(projectId: string, data: any) {
    const client = await this.pool.connect();
  ...
  async getSOLIDViolations(projectId: string, filters: any = {}) {
  ...
  async saveSOLIDViolations(projectId: string, data: any[]) {
    const client = await this.pool.connect();
  ...
  async getToolData(projectId: string, toolName: string, filters: any = {}) {
...
router.delete('/:projectId/:toolName', async (req, res): Promise<any> => {
  try {
    const { projectId, toolName } = req.params;
...
router.post('/:projectId/semantic-search/search', async (req, res): Promise<any> => {
  try {
