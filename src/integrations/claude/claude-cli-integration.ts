...
export class ClaudeCodeIntegration {
  ...
  async executeClaudeCode(
    ...
    try {
      ...
      const result = await CommandProcessor.executeClaudeCode(processedPrompt, {
...
`;
   ...
   */
  async detectUserIntentSimple(userRequest: string): Promise<{
    category: string;
    confidence: number;
...
Response:`;
    ...
    try {
      const response = await CommandProcessor.executeClaudeCode(intentPrompt, {
...
Response:`;
    ...
    const response = await CommandProcessor.executeClaudeCode(
  ...
  private async buildEnhancedContext(
    ...
    const { ContextBuilder } = await import('../../cli/integration/context-builder');
  ...
  private async decomposeIntoTasks(userRequest: string, intent: any): Promise<any[]> {
    const { TaskDecomposer } = await import('../../cli/integration/task-decomposer');
  ...
  private async integrateResults(results: any[]): Promise<any> {
    const { ResultIntegrator } = await import('../../cli/integration/result-integrator');
  ...
  private async updateKnowledgeBase(analysis: any): Promise<void> {
    const { KnowledgeBaseUpdater } = await import('../../cli/integration/knowledge-base-updater');
  ...
  private async getProjectStructure(projectPath: string): Promise<string> {
    const { ProjectStructureAnalyzer } = await import('../../cli/analyzers/project-structure-analyzer');
  ...
  private async getKeyConfigurations(projectPath: string): Promise<string> {
    const { ConfigurationAnalyzer } = await import('../../cli/analyzers/configuration-analyzer');
  ...
  private async getRecentChanges(projectPath: string): Promise<string | null> {
    const { ChangeAnalyzer } = await import('../../cli/analyzers/change-analyzer');
  ...
  private async getProjectDocumentation(projectPath: string): Promise<string | null> {
    const { DocumentationAnalyzer } = await import('../../cli/analyzers/documentation-analyzer');
