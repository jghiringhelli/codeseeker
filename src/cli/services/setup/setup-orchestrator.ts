...
export class SetupOrchestrator implements ISetupOrchestrator {
  ...
  constructor(
    private prerequisiteChecker: IPrerequisiteChecker,
    private containerDetector: IContainerDetector,
    private containerManager: IContainerManager,
    private databaseInitializer: IDatabaseInitializer,
    private reporter: ISetupReporter
  ) {}
  ...
  private async checkPrerequisites(options: SetupOptions): Promise<SetupResult> {
  ...
  private async detectContainerSystem(): Promise<any> {
  ...
  private async setupContainers(config: any): Promise<SetupResult> {
  ...
  private async handleNonContainerSetup(): Promise<void> {
