...
import { InteractiveProjectFixer, InteractiveFixerOptions } from '../../auto-improvement/interactive-project-fixer';
    ...
    .action(async (projectPath: string, options: any) => {
      try {
        ...
        if (options.interactive) {
          ...
          const interactiveOptions: InteractiveFixerOptions = {
          ...
          const interactiveFixer = new InteractiveProjectFixer();
