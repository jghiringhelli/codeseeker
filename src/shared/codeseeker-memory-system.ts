/**
 * CodeSeeker Memory System (Legacy Facade)
 ...
 *
 * This class provides backward compatibility for existing CodeSeeker memory operations
...
export class CodeSeekerMemorySystem {
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.logger.info('🧠 CodeSeeker memory system initialized (legacy facade)');
    } catch (error) {
  ...
  async close(): Promise<void> {
    ...
    try {
      ...
      this.logger.info('🧠 CodeSeeker memory system closed (legacy facade)');
    } catch (error) {
   ...
   * Main entry point for CodeSeeker → Claude Code interactions
   */
  ...
  async recordInteraction(
    ...
    if (typeof interactionOrRequestId === 'string') {
      ...
      const interaction: InteractionMemory = {
        ...
        codeseekerRequest: codeseekerRequest,
...
export default CodeSeekerMemorySystem;
export { MemorySystem };