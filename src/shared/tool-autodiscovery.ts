...
import { InternalTool, ToolMetadata, ToolRegistry, AnalysisResult, ToolInitResult, ToolUpdateResult } from './tool-interface';
...
export class ToolAutodiscoveryService {
   ...
   */
  async initializeProjectForAllTools(projectPath: string, projectId: string): Promise<{
    success: boolean;
    ...
    const results = new Map<string, ToolInitResult>();
   ...
   */
  async analyzeProjectWithAllTools(projectPath: string, projectId: string): Promise<{
    success: boolean;
   ...
   */
  async updateToolsAfterCliRequest(
    projectPath: string, 
    projectId: string, 
    cliCommand: string, 
    cliResult: any
    ...
    const results = new Map<string, ToolUpdateResult>();
    let allSuccess = true;
   ...
   */
  async getToolsStatus(projectId: string): Promise<Array<{
    name: string;
    category: string;
    status: any;
  }>> {
