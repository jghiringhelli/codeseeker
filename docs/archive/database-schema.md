...
> **Architecture Documentation** | [← Back to Architecture](README.md) | [Core Tables](#core-tables) | [Data Flow](#data-flow-expectations)
...
> **Next**: [Tree Traversal](tree-traversal.md) | **Related**: [Features Overview](../features/overview.md)