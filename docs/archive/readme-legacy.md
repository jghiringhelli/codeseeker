# CodeMind - Intelligent Claude Code Enhancement Platform

**Version**: 2.0.0  
**Architecture**: Three-Layer System (CLI → Orchestrator → Planner)

CodeMind is an intelligent enhancement platform for Claude Code that provides smart tool selection, workflow orchestration, and project management through a layered architecture approach.
