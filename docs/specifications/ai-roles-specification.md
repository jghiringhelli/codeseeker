# AI Roles & Knowledge Integration

> **Feature Documentation** | [← Back to Features](README.md) | [Role Architecture](#architecture) | [Tree Traversal Integration](#tree-traversal-integration)
