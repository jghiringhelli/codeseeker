...
const tree_sitter_python_parser_1 = require("./parsers/tree-sitter-python-parser");
const tree_sitter_java_parser_1 = require("./parsers/tree-sitter-java-parser");
const node_builder_1 = require("./builders/node-builder");
const relationship_builder_1 = require("./builders/relationship-builder");
...
class CodeRelationshipOrchestrator {
    ...
    constructor(semanticGraph) {
        ...
        this.nodeBuilder = new node_builder_1.NodeBuilder(semanticGraph);
        this.relationshipBuilder = new relationship_builder_1.RelationshipBuilder(semanticGraph);
    ...
    initializeParsers() {
        ...
        const regexParsers = [
            new typescript_parser_1.TypeScriptParser(), // Always available (Babel)
            new python_parser_1.PythonParser(), // Regex fallback
            new java_parser_1.JavaParser() // Regex fallback
        ];
        ...
        this.genericParser = new generic_parser_1.GenericParser();
    ...
    initializeTreeSitterParsers() {
        ...
        try {
            ...
            const pythonParser = new tree_sitter_python_parser_1.TreeSitterPythonParser();
        ...
        try {
            ...
            const javaParser = new tree_sitter_java_parser_1.TreeSitterJavaParser();
...
//# sourceMappingURL=code-relationship-orchestrator.js.map