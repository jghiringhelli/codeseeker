...
exports.TreeSitterPythonParser = void 0;
const ILanguageParser_1 = require("./ILanguageParser");
class TreeSitterPythonParser extends ILanguageParser_1.BaseLanguageParser {
    parser = null;
    language = null;
    initialized = false;
    constructor() {
    ...
    async initializeParser() {
        try {
            ...
            let TreeSitter, Python;
            try {
                const treeSitterModule = await Promise.resolve(`${'tree-sitter'}`).then(s => __importStar(require(s)));
                const pythonModule = await Promise.resolve(`${'tree-sitter-python'}`).then(s => __importStar(require(s)));
    ...
    extractFunctionsFromAST(rootNode, structure) {
    ...
    extractDecoratorsFromAST(rootNode, structure) {
    ...
    extractSuperclasses(superclassesNode) {
        const superclasses = [];
    ...
    parseImportsRegex(line, structure) {
    ...
    parseClassesRegex(line, lines, currentIndex, structure) {
    ...
    parseFunctionsRegex(line, structure) {
...
exports.TreeSitterPythonParser = TreeSitterPythonParser;
//# sourceMappingURL=TreeSitterPythonParser.js.map