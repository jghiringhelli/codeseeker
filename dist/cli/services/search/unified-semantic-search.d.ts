...
export declare class UnifiedSemanticSearchService extends AnalysisTool implements IProjectIndexer {
    id: string;
    name: string;
    description: string;
    version: string;
    ...
    performAnalysis(context: any): Promise<any>;
...
export default UnifiedSemanticSearchService;
//# sourceMappingURL=unified-semantic-search.d.ts.map