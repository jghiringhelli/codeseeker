...
exports.SearchIndexStorage = void 0;
class SearchIndexStorage {
    dbConnections;
    constructor(dbConnections) {
        this.dbConnections = dbConnections;
    }
    async storeChunks(projectId, chunks, embeddings) {
    ...
    async removeChunks(projectId, filePaths) {
    ...
    async updateChunkContent(chunkId, content, embedding) {
        const postgres = await this.dbConnections.getPostgresConnection();
        const query = `
...
exports.SearchIndexStorage = SearchIndexStorage;
//# sourceMappingURL=search-index-storage.js.map