...
exports.SearchQueryProcessor = void 0;
class SearchQueryProcessor {
    embeddingGenerator;
    indexStorage;
    constructor(embeddingGenerator, indexStorage) {
    ...
    async executeSimilaritySearch(queryEmbedding, query) {
    ...
    generateMatchReason(similarity, result, query) {
        if (similarity > 0.8) {
...
exports.SearchQueryProcessor = SearchQueryProcessor;
//# sourceMappingURL=search-query-processor.js.map