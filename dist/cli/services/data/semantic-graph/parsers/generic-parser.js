...
class GenericParser extends ilanguage_parser_1.BaseLanguageParser {
    ...
    async performBasicAnalysis(content, structure) {
    ...
    extractBasicImports(lines, structure) {
    ...
    extractBasicFunctions(lines, structure) {
        for (const line of lines) {
            const trimmed = line.trim();
    ...
    extractBasicClasses(lines, structure) {
        for (const line of lines) {
            const trimmed = line.trim();
    ...
    extractKeywords(content, structure) {
