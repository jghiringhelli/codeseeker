...
exports.InitializationStatusTracker = void 0;
const database_config_1 = require("../../../config/database-config");
const logger_1 = require("../../../utils/logger");
class InitializationStatusTracker {
    dbConnections;
     ...
     */
    async initializeProject(projectId, projectName, projectPath) {
     ...
     */
    async updateStageStatus(projectId, update) {
     ...
     */
    async canResumeInitialization(projectId) {
     ...
     */
    async clearErrorState(projectId) {
        try {
            const pgClient = await this.dbConnections.getPostgresConnection();
            await pgClient.query(`
        UPDATE initialization_status
     ...
     */
    async displayProgress(projectId) {
        const status = await this.getProjectStatus(projectId);
        if (!status) {
    ...
    async checkCompletionStatus(projectId) {
        try {
            const pgClient = await this.dbConnections.getPostgresConnection();
...
exports.InitializationStatusTracker = InitializationStatusTracker;
exports.default = InitializationStatusTracker;
//# sourceMappingURL=initialization-status-tracker.js.map