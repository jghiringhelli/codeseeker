...
class SyncManagerService {
    ...
    async updateEmbeddings(files, projectPath) {
        try {
            const { EmbeddingService } = await Promise.resolve().then(() => __importStar(require('./embedding-service')));
    ...
    async updateSemanticGraph(files, projectPath) {
        try {
            const { SemanticGraphService } = await Promise.resolve().then(() => __importStar(require('./semantic-graph')));
