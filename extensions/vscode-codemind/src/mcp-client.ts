 ...
 * MCP Client
 *
 * Communicates with CodeMind MCP server to sync file changes.
...
export class McpClient implements vscode.Disposable {
  ...
  constructor(private config: McpClientConfig) {
    this.outputChannel = vscode.window.createOutputChannel('CodeMind MCP');
  }
