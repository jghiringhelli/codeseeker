 ...
 * Status Bar Manager
 *
 * Shows CodeMind sync status in the VSCode status bar.
 */
...
export class StatusBarManager implements vscode.Disposable {
  ...
  constructor() {
    ...
    this.statusBarItem.command = 'codemind.showStatus';
    this.update();
  }
    ...
    switch (this.currentStatus) {
      case 'syncing':
        return {
          icon: '$(sync~spin)',
          text: 'CodeMind',
          tooltip: customMessage || 'Syncing changes to CodeMind...',
          color: undefined
        };
      ...
      default:
        ...
        return {
          icon: '$(database)',
          text: `CodeMind${pendingText}`,
          tooltip: `CodeMind Index Sync${lastSyncText}\n\nClick for options`,
          color: undefined
        };
    }
  }
